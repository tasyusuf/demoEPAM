...
//           if we do not pass the driver from terminal then use the one properties file
            ...
            switch (browser) {
                ...
                case "remote_chrome":
                    ...
                    try {
                        driverPool.set(new RemoteWebDriver(new URL("https://oauth-ytas9293-3265b:06db1077-c53d-405e-ad87-0ca269530a87@ondemand.eu-central-1.saucelabs.com:443/wd/hub"),chromeOptions));
